...
cmake -B build -DBUILD_SHARED_LIBS=OFF -DWHISPER_METAL=ON -DWHISPER_FLASH_ATTN=ON -DCMAKE_OSX_ARCHITECTURES="arm64" -DGGML_NATIVE=OFF -DWHISPER_NATIVE=OFF && cmake --build build -j --config Release
